<modal-window v-bind:do-active="modalStates.login"
    ...
    <custom-form-ajax
        ...
        <div class="form-items-s" slot="formParts" slot-scope="{ doAjaxSubmit, hasError, getErrorMsg }">
            <!--<p class="text-form-notice text-attention">エラーメッセージなどエラーメッセージなどエラーメッセージなどエラーメッセージなどエラーメッセージなどエラーメッセージなどエラーメッセージなどエラーメッセージなどエラーメッセージなどエラーメッセージなどエラーメッセージなどエラーメッセージなど</p>-->
            ...
            <div class="form-item-group">
                <ul class="layout-h-btn-box">
                    ...
                    <li class=""><a href="#" id="loginSubmit"
                                    ...
                                    @click.prevent="doAjaxSubmit()">{{ __('label.btn.ok') }}</a></li>
                </ul>
            </div>
